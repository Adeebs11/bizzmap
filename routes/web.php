...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::post('/pending/bulk-approve', [AdminController::class, 'bulkApprove'])->name('admin.pending.bulkApprove');
    Route::post('/pending/bulk-reject', [AdminController::class, 'bulkReject'])->name('admin.pending.bulkReject');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::patch('/locations/{id}/toggle-potential', [LocationController::class, 'togglePotential'])->name('locations.togglePotential');
    Route::get('/locations/{id}/history', [LocationController::class, 'history'])->name('locations.history');
